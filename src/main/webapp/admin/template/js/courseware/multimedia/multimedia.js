jQuery(function ($) {
  $(document).ready(function () {
    function getDocument() {
      ...
      $.ajax({
        type: "GET",
        url: "/api/admin/courseWare/allMultimedia",
        headers: {
        ...
        beforeSend: function () {
          ...
          if ($("#multimedia-table2 tbody").html() == "") {
            $("#multimedia-table2").DataTable({
              language: {
                paginate: {
                  previous: "Trước",
                  next: "Sau",
            ...
            $("#multimedia-table").DataTable().clear().draw();
          }
        },
          ...
          $.each(response, function (i, v) {
            ...
            if (v.type_video == 1) {
              video_show =
                ...
                "                                </video>" +
                '<a>Dung lượng file :</a><a class="badge badge-warning">' +
                v.size +
                "</a>";
            }
            if (v.type_video == 2) {
...
function deleteCourse_Ware(id) {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      console.log(response);
      window.location.href = "/admin/courseware/video/index";
    },
    error: function (response) {
      console.log("fail");
