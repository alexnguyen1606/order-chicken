jQuery(function ($) {
  $(document).ready(function () {
    function getDocument() {
      ...
      $.ajax({
        type: "GET",
        url: "/api/admin/courseWare/allScorm",
        headers: {
        ...
        beforeSend: function () {
          ...
          if ($("#scorm_table tbody").html() == "") {
            $("#scorm_table").DataTable({
              language: {
                paginate: {
                  previous: "Trước",
                  next: "Sau",
            ...
            $("#scorm_table").DataTable().clear().draw();
          }
        },
...
function deleteCourse_Ware(id) {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      console.log(response);
      window.location.href = "/admin/courseware/scorm";
    },
    error: function (response) {
      console.log("fail");
