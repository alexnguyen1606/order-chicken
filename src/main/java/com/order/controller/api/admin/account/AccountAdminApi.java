package com.order.controller.api.admin.account;
...
public class AccountAdminApi {
    ...
    public ResponseEntity<ServiceResult> getListAccount(@RequestBody AccountDTO accountDTO,
                                                             ...
                                                             @RequestParam(name = "size", defaultValue = "10", required = false) Integer size) throws InterruptedException, ExecutionException {
